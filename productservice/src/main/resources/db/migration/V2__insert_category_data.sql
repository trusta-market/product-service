...
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
SELECT gen_random_uuid(), '명품 가방', parent.id, 1, 1, NULL, NULL FROM parent UNION ALL
...
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
SELECT gen_random_uuid(), '스니커즈/운동화', parent.id, 1, 1, NULL, NULL FROM parent UNION ALL
SELECT gen_random_uuid(), '일반 의류',       parent.id, 1, 2, NULL, NULL FROM parent UNION ALL
...
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
SELECT gen_random_uuid(), '스마트폰',      parent.id, 1, 1, NULL, NULL FROM parent UNION ALL
SELECT gen_random_uuid(), '노트북/태블릿', parent.id, 1, 2, NULL, NULL FROM parent UNION ALL
...
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
SELECT gen_random_uuid(), '골프용품', parent.id, 1, 1, NULL, NULL FROM parent UNION ALL
...
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
SELECT gen_random_uuid(), '가구/인테리어', parent.id, 1, 1, NULL, NULL     FROM parent UNION ALL
SELECT gen_random_uuid(), '식품/건강',     parent.id, 1, 2, NULL, 'NEVER'  FROM parent UNION ALL
SELECT gen_random_uuid(), '티켓/상품권',   parent.id, 1, 3, NULL, 'ALWAYS' FROM parent UNION ALL
SELECT gen_random_uuid(), '도서/잡지',     parent.id, 1, 4, NULL, 'NEVER'  FROM parent;