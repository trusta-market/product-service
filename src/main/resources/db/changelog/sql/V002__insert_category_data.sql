...
WITH parent AS (SELECT id FROM p_categories WHERE name = '패션' AND depth = 0 AND parent_id IS NULL)
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
...
WITH parent AS (SELECT id FROM p_categories WHERE name = '전자기기' AND depth = 0 AND parent_id IS NULL)
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
...
WITH parent AS (SELECT id FROM p_categories WHERE name = '스포츠/레저' AND depth = 0 AND parent_id IS NULL)
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
...
WITH parent AS (SELECT id FROM p_categories WHERE name = '취미/수집' AND depth = 0 AND parent_id IS NULL)
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
...
WITH parent AS (SELECT id FROM p_categories WHERE name = '생활/기타' AND depth = 0 AND parent_id IS NULL)
INSERT INTO p_categories (id, name, parent_id, depth, display_order, inspection_threshold, inspection_policy)
